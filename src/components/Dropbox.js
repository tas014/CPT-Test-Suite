...
const Dropbox = ({ icon, title, handleDrop, handleFileUpload, type, res = false, fil, handleDelete, handleResDownload }) => {
    ...
    return (
        <div className='dropboxContainer'>
            ...
            {res && fil.length > 0 ? <Button cl='RES-btn' content='Descargar RTQ RES521-24' click={handleResDownload} enabled={true} /> : null}
        </div>
    )
}
